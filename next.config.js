		...
		return [
			{
				...
				headers: [
					...
					// CSP re-enabled for better security control
					{
						...
						value: [
							...
							"frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://challenges.cloudflare.com https://www.youtube-nocookie.com https://saleor-digital-downloads.sonicdrivestudio.com",
					...
					// CSP Report-Only for monitoring without breaking functionality
					{
						...
						value: [
							...
							"frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://challenges.cloudflare.com https://www.youtube-nocookie.com",
							"worker-src 'self' blob:",
							"object-src 'none'",
							"base-uri 'self'",
							"form-action 'self'",
